...
#nullable enable
        public async Task<global::HraBot.ApiClient.Models.ApprovedResponseContract?> PostAsync(global::HraBot.ApiClient.Models.ChatRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::HraBot.ApiClient.Models.ApprovedResponseContract> PostAsync(global::HraBot.ApiClient.Models.ChatRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::HraBot.ApiClient.Models.ApprovedResponseContract>(requestInfo, global::HraBot.ApiClient.Models.ApprovedResponseContract.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
